...
public interface AuthService {
     ...
     * 学生自助注册，注册成功后直接返回登录态。
     *
     * <p>创建用户、绑定「学生」角色，并建一份学生档案（学号由系统生成占位值，
     * 学院/专业/班级留空，等学校管理员补录）。建档不能省：会话里的 studentId
     * 取自档案 id，没有档案的学生一登录，「我的报名 / 我的时长 / 我的画像」
     * 就都会报 10003。建档与建号在同一个事务里，注册失败不会留下有账号、没档案的孤儿。
     *
     * @param dto 注册参数
     * @return token 与用户信息
